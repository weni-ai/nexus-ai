...
def generate_env():
    ...
    VARIABLES = {
        ...
        "FEW_SHOT_CHATGPT": "",
        "BEDROCK_DIRECT_INGESTION_PROJECT_ALLOWLIST": "",
        "BEDROCK_DIRECT_INGEST_MAX_RETRIES": "3",
        "BEDROCK_DIRECT_INGEST_BACKOFF_BASE_SECONDS": "2",
        "BEDROCK_DIRECT_INGEST_POLL_INTERVAL_SECONDS": "5",
        "BEDROCK_DIRECT_INGEST_POLL_MAX_ATTEMPTS": "60",
        "BEDROCK_DISABLE_GLOBAL_INGESTION_JOB": "false",
