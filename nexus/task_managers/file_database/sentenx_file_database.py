...
class SentenXFileDataBase:
    ...
    def search_data(self, content_base_uuid: str, text: str):
        ...
        body = {
            ...
            "filter": {"content_base_uuid": content_base_uuid},
        }
...
class SentenXDocumentPreview(DefaultSentenXData):
    def paginate_content(self, content: list, page_size: int, page_number: int) -> dict:
    ...
    def document_preview(
        self, content_base_file_uuid: str, content_base_uuid: str, page_size: int, page_number: int
    ) -> dict:
        ...
        try:
            ...
            paginated_content = self.paginate_content(content=content, page_size=page_size, page_number=page_number)

            return {"status": response.status_code, "data": paginated_content}
