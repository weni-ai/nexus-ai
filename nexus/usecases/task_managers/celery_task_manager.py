...
class CeleryTaskManagerUseCase:
    ...
    def create_celery_task_manager(self, content_base_file: ContentBaseFile) -> ContentBaseFileTaskManager:
        ...
        import logging
        logging.getLogger(__name__).info("Creating ContentBaseFileTaskManager", extra={"uuid": str(content_base_task_manager.uuid)})
        return content_base_task_manager
    ...
    def create_celery_text_file_manager(self, content_base_text: ContentBaseText) -> ContentBaseTextTaskManager:
        ...
        import logging
        logging.getLogger(__name__).info("Creating ContentBaseTextTaskManager", extra={"uuid": str(content_base_task_manager.uuid)})
        return content_base_task_manager
    ...
    def create_celery_link_manager(self, content_base_link: ContentBaseLink) -> ContentBaseLinkTaskManager:
        ...
        import logging
        logging.getLogger(__name__).info("Creating ContentBaseLinkTaskManager", extra={"uuid": str(content_base_task_manager.uuid)})
        return content_base_task_manager
