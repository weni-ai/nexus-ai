...
def create_lambda_conversation(
    ...
    try:
        ...
        try:
            conversation_to_update = Conversation.objects.get(
                external_id=payload.get("external_id"),
                project=project
            )
        except Conversation.DoesNotExist:
            sentry_sdk.capture_message("Conversation record not found, ingress logic failed.")
            raise
        ...
        conversation_to_update.start_date = payload.get("start_date")
        conversation_to_update.end_date = payload.get("end_date")
        conversation_to_update.has_chats_room = payload.get("has_chats_room")
        conversation_to_update.resolution = resolution_choice_value 
        conversation_to_update.topic = topic
        conversation_to_update.channel_uuid = payload.get("channel_uuid")
        
        if contact_name:
            conversation_to_update.contact_name = contact_name
