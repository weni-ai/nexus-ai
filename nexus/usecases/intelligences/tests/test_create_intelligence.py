...
class TestListIntelligenceUseCase(TestCase):
    ...
    def test_create_intelligence_use_case(self):
        ...
        intelligences_create = use_case.create_intelligences(
            name="name", description="description", org_uuid=self.org.uuid, user_email=self.org.created_by
        )
...
class TestCreateIntegratedIntelligence(TestCase):
    ...
    def test_create_integrated_intelligence(self):
        ...
        self.assertEqual(integrated_intelligence.intelligence.uuid, self.integrated_inteligence.intelligence.uuid)
        self.assertEqual(integrated_intelligence.project.uuid, self.integrated_inteligence.project.uuid)
