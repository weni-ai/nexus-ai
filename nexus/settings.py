...
DEFAULT_FROM_EMAIL = env.str("DEFAULT_FROM_EMAIL", default="no-reply@weni.ai")
EMAIL_SUBJECT_PREFIX = env.str("EMAIL_SUBJECT_PREFIX", default="[Nexus AI] ")
...
FLOWS_DB_COHORT_HTTP_TIMEOUT = env.int("FLOWS_DB_COHORT_HTTP_TIMEOUT", default=300)
FLOWS_DB_COHORT_TASK_TIME_LIMIT = env.int("FLOWS_DB_COHORT_TASK_TIME_LIMIT", default=3600)
FLOWS_DB_COHORT_EMAIL_UUID_SAMPLE_LIMIT = env.int("FLOWS_DB_COHORT_EMAIL_UUID_SAMPLE_LIMIT", default=10)
...
ELASTIC_APM_LAMBDA_EXTENSION_VERSION = env.str("ELASTIC_APM_LAMBDA_EXTENSION_VERSION", "1-6-0")
ELASTIC_APM_LAMBDA_PYTHON_AGENT_VERSION = env.str("ELASTIC_APM_LAMBDA_PYTHON_AGENT_VERSION", "6-25-0")
...
BEDROCK_DIRECT_INGESTION_PROJECT_ALLOWLIST = env.list("BEDROCK_DIRECT_INGESTION_PROJECT_ALLOWLIST", default=[])
BEDROCK_DIRECT_INGEST_MAX_RETRIES = env.int("BEDROCK_DIRECT_INGEST_MAX_RETRIES", default=3)
BEDROCK_DIRECT_INGEST_BACKOFF_BASE_SECONDS = env.int("BEDROCK_DIRECT_INGEST_BACKOFF_BASE_SECONDS", default=2)
BEDROCK_DIRECT_INGEST_POLL_INTERVAL_SECONDS = env.int("BEDROCK_DIRECT_INGEST_POLL_INTERVAL_SECONDS", default=5)
BEDROCK_DIRECT_INGEST_POLL_MAX_ATTEMPTS = env.int("BEDROCK_DIRECT_INGEST_POLL_MAX_ATTEMPTS", default=60)
BEDROCK_DISABLE_GLOBAL_INGESTION_JOB = env.bool("BEDROCK_DISABLE_GLOBAL_INGESTION_JOB", default=True)
