...
AWS_BEDROCK_OPENSEARCH_INDEX_NAME = env.str(
    "AWS_BEDROCK_OPENSEARCH_INDEX_NAME", default="bedrock-knowledge-base-default-index"
)
...
BEDROCK_INGESTION_JOB_ENABLED = env.bool("BEDROCK_INGESTION_JOB_ENABLED", True)
...
FLOWS_DB_COHORT_JSON_MAX_RANGE_DAYS = env.int("FLOWS_DB_COHORT_JSON_MAX_RANGE_DAYS", default=1)
...
# Feature flags (GrowthBook via weni-feature-flags)
_growthbook_client_key_default = "test" if TESTING else ""
_growthbook_host_default = "https://cdn.growthbook.io"
GROWTHBOOK_CLIENT_KEY = env.str("GROWTHBOOK_CLIENT_KEY", default=_growthbook_client_key_default)
