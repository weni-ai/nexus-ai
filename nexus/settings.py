...
# Agent Builder 2.0 temporary vars

AGENT_BUILDER_2_PROJECTS = env.list("AGENT_BUILDER_2_PROJECTS", "")
DOUBT_ANALYST_EXTERNAL_ID = env.str("DOUBT_ANALYST_EXTERNAL_ID", "")
AWS_BEDROCK_AGENTS_MODEL_ID = env.str("AWS_BEDROCK_AGENTS_MODEL_ID", "")
AWS_BEDROCK_SUPERVISOR_MODEL_ID = env.str("AWS_BEDROCK_SUPERVISOR_MODEL_ID", "")
