...
# Bedrock
BEDROCK_DATE = env.str("BEDROCK_DATE", "2024-08-01T00:00:00+00:00")

AWS_BEDROCK_ACCESS_KEY_ID = env.str("AWS_BEDROCK_ACCESS_KEY_ID", os.environ.get("AWS_ACCESS_KEY_ID"))
AWS_BEDROCK_SECRET_ACCESS_KEY = env.str("AWS_BEDROCK_SECRET_ACCESS_KEY", os.environ.get("AWS_SECRET_ACCESS_KEY"))
AWS_S3_KNOWLEDGEBASE_ID = env.str("AWS_S3_KNOWLEDGEBASE_ID")
AWS_S3_DATASOURCE_ID = env.str("AWS_S3_DATASOURCE_ID")
AWS_S3_BEDROCK_BUCKET_NAME = env.str("AWS_S3_BEDROCK_BUCKET_NAME")
