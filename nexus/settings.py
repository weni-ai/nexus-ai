...
REFLECTION_ENABLED = env.bool("REFLECTION_ENABLED", default=True)

if REFLECTION_ENABLED:
    REFLECTION_URL = env.str("REFLECTION_URL", WENIGPT_SHARK_API_URL)
    REFLECTION_PROMPT = env.str("REFLECTION_PROMPT")
    REFLECTION_MODEL = env.str("REFLECTION_MODEL", WENIGPT_SHARK)
