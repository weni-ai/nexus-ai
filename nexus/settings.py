...
# PROMPT INTRODUCTION
WENIGPT_PROMPT_INTRODUCTION_PT = env.str("WENIGPT_PROMPT_INTRODUCTION_PT")
WENIGPT_PROMPT_INTRODUCTION_EN = env.str("WENIGPT_PROMPT_INTRODUCTION_EN")
WENIGPT_PROMPT_INTRODUCTION_ES = env.str("WENIGPT_PROMPT_INTRODUCTION_ES")

WENIGPT_PROMPT_INTRODUCTION = {
    "pt": WENIGPT_PROMPT_INTRODUCTION_PT,
    "en": WENIGPT_PROMPT_INTRODUCTION_EN,
    "es": WENIGPT_PROMPT_INTRODUCTION_ES,
}

# PROMPT QUESTION
WENIGPT_PROMPT_QUESTION_PT = env.str("WENIGPT_PROMPT_QUESTION_PT")
WENIGPT_PROMPT_QUESTION_EN = env.str("WENIGPT_PROMPT_QUESTION_EN")
WENIGPT_PROMPT_QUESTION_ES = env.str("WENIGPT_PROMPT_QUESTION_ES")

WENIGPT_PROMPT_QUESTION = {
    "pt": WENIGPT_PROMPT_QUESTION_PT,
    "en": WENIGPT_PROMPT_QUESTION_EN,
    "es": WENIGPT_PROMPT_QUESTION_ES,
}


# PROMPT TEXT
WENIGPT_PROMPT_TEXT_PT = env.str("WENIGPT_PROMPT_TEXT_PT")
WENIGPT_PROMPT_TEXT_EN = env.str("WENIGPT_PROMPT_TEXT_EN")
WENIGPT_PROMPT_TEXT_ES = env.str("WENIGPT_PROMPT_TEXT_ES")

WENIGPT_PROMPT_TEXT = {
    "pt": WENIGPT_PROMPT_TEXT_PT,
    "en": WENIGPT_PROMPT_TEXT_EN,
    "es": WENIGPT_PROMPT_TEXT_ES,
}

# PROMPT_REINFORCEMENT_INSTRUCTION
WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_PT = env.str("WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_PT")
WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_EN = env.str("WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_EN")
WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_ES = env.str("WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_ES")

WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION = {
    "pt": WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_PT,
    "en": WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_EN,
    "es": WENIGPT_PROMPT_REINFORCEMENT_INSTRUCTION_ES,
}

# WENIGPT_PROMPT_ANSWER
WENIGPT_PROMPT_ANSWER_PT = env.str("WENIGPT_PROMPT_ANSWER_PT")
WENIGPT_PROMPT_ANSWER_EN = env.str("WENIGPT_PROMPT_ANSWER_EN")
WENIGPT_PROMPT_ANSWER_ES = env.str("WENIGPT_PROMPT_ANSWER_ES")

WENIGPT_PROMPT_ANSWER = {
    "pt": WENIGPT_PROMPT_ANSWER_PT,
    "en": WENIGPT_PROMPT_ANSWER_EN,
    "es": WENIGPT_PROMPT_ANSWER_ES,
}