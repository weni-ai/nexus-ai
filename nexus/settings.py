...
WENIGPT_BETA_API_URL = env.str("WENIGPT_BETA_API_URL", WENIGPT_API_URL)
WENIGPT_BETA_API_TOKEN = env.str("WENIGPT_BETA_API_TOKEN", WENIGPT_API_TOKEN)
WENIGPT_BETA_COOKIE = env.str("WENIGPT_BETA_API_URL", WENIGPT_COOKIE)
WENIGPT__BETA_OPENAI_TOKEN = env.str("WENIGPT_BETA_API_URL", WENIGPT_API_TOKEN)
WENIGPT_BETA_STOP = env.str("WENIGPT_BETA_API_URL", WENIGPT_STOP)
