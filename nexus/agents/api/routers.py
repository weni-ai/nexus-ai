...
urlpatterns = [
    ...
    path('agents/teams/<project_uuid>', VTexAppTeamView.as_view(), name="vtex-teams"),
    path('agents/my-agents/<project_uuid>', AgentsView.as_view(), name="my-agents"),
    path('agents/my-agents/<project_uuid>', VtexAppAgentsView.as_view(), name="vtex-my-agents"),
    ...
    path('project/<project_uuid>/assign/<str:agent_uuid>', VtexAppActiveAgentsViewSet.as_view(), name="vtex-assign-agents"),
