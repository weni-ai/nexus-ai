...
class LLMClient(ABC):
    ...
    def chat_completion(self, instructions: List, chunks: List, agent: Dict, question: str, llm_config: LLMSetupDTO, few_shot: str):
        ...
        print(f"[+ Messages para o LLM: {messages} +]")
