...
class ContentBasePersonalizationSerializerTestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.content_base = ContentBaseFactory(intelligence=intelligence, created_by=integrated_intelligence.created_by)
    ...
    def test_update_agent(self, mock_event_manager):
        ...
        serializer = ContentBasePersonalizationSerializer(
            instance=self.content_base, data={"agent": agent_data}, context={"request": request}, partial=True
        )
