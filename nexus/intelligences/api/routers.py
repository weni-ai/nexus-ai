...
urlpatterns = [
    ...
    path('<project_uuid>/topics/<topic_uuid>/', TopicsViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='topic-detail'),
    path('<project_uuid>/topics/<topic_uuid>/subtopics/', SubTopicsViewSet.as_view({'get': 'list', 'post': 'create'}), name='subtopics'),
    path('<project_uuid>/topics/<topic_uuid>/subtopics/<subtopic_uuid>/', SubTopicsViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='subtopic-detail'),
