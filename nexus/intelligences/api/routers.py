...
urlpatterns = [
    ...
    path('<project_uuid>/inline-content-base-file/', InlineContentBaseFileViewset.as_view({'get': 'list', 'post': 'create', 'delete': 'destroy'}), name="inline-content-base-file"),
    path('<project_uuid>/inline-content-base-text/', InlineContentBaseTextViewset.as_view({'get': 'list', 'post': 'create', 'put': 'update', 'delete': 'destroy'}), name="inline-content-base-text"),
    path('<project_uuid>/inline-content-base-link/', InlineContentBaseLinkViewset.as_view({'get': 'list', 'post': 'create', 'delete': 'destroy'}), name="inline-content-base-link"),
