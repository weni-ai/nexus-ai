...
urlpatterns = [
    ...
    path('<project_uuid>/inline-content-base-text/', InlineContentBaseTextViewset.as_view({'get': 'list', 'post': 'create', 'put': 'update'}), name="inline-content-base-text"),
    path('<project_uuid>/inline-content-base-text/<contentbasetext_uuid>/', InlineContentBaseTextViewset.as_view({'delete': 'destroy'}), name="inline-content-base-text-detail"),
