...
urlpatterns = [
    ...
    path('<project_uuid>/inline-content-base-file/', InlineContentBaseFileViewset.as_view({'get': 'list', 'post': 'create'}), name="inline-content-base-file"),
    path('<project_uuid>/inline-content-base-file/<contentbase_file_uuid>/', InlineContentBaseFileViewset.as_view({'delete': 'destroy', 'get': 'retrieve'}), name="inline-content-base-file-detail"),
    path('<project_uuid>/inline-content-base-text/', InlineContentBaseTextViewset.as_view({'get': 'list', 'post': 'create'}), name="inline-content-base-text"),
    path('<project_uuid>/inline-content-base-text/<contentbasetext_uuid>/', InlineContentBaseTextViewset.as_view({'delete': 'destroy', 'put': 'update'}), name="inline-content-base-text-detail"),
    path('<project_uuid>/inline-content-base-link/', InlineContentBaseLinkViewset.as_view({'get': 'list', 'post': 'create'}), name="inline-content-base-link"),
    path('<project_uuid>/inline-content-base-link/<contentbaselink_uuid>/', InlineContentBaseLinkViewset.as_view({'delete': 'destroy', 'get': 'retrieve'}), name="inline-content-base-link-detail"),
