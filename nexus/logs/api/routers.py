...
urlpatterns = [
    ...
    path(
        "<project_uuid>/message_history/", MessageHistoryViewset.as_view({"get": "list"}), name="list-message-history"
    ),
    ...
    path(
        "<project_uuid>/conversation-context/",
        ConversationContextViewset.as_view({"get": "list"}),
        name="list-conversation-context",
    ),
    path(
        "<project_uuid>/conversations/",
        InlineConversationsViewset.as_view({"get": "list"}),
        name="list-inline-conversations",
    ),
]
