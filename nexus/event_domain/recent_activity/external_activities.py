...
def intelligence_activity_message(recent_activities_dto: RecentActivitiesDTO):  # pragma: no cover
    ...
    publisher.send_message(body=message, exchange="recent-activities.topic", routing_key="")
