...
from nexus.mixins import ExceptionHandlerMixin
...
class FlowsViewset(ModelViewSet, ExceptionHandlerMixin):
    ...
    @ExceptionHandlerMixin.handle_exceptions
...
class MessagePreviewView(APIView, ExceptionHandlerMixin):
...
class GenerateActionNameView(APIView, ExceptionHandlerMixin):
...
class TemplateActionView(ModelViewSet, ExceptionHandlerMixin):
