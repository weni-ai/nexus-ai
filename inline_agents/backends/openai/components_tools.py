...
quick_replies_tool = FunctionTool(
    ...
    description=(
        "Creates a message with 2-3 quick reply options. " "Use when the user needs to choose between simple options."
    ),
...
list_message_tool = FunctionTool(
    ...
    description=(
        "Creates a message with list of 4-10 options with descriptions. "
        "Use when there are multiple options that need explanation."
    ),
...
cta_message_tool = FunctionTool(
    ...
    description=(
        "Creates a message with Call to Action (CTA) button with URL. "
        "Use when the user needs to access an external link."
    ),
...
simple_text_with_quick_replies_tool = FunctionTool(
    ...
    description=(
        "Creates a simple text message followed by quick reply options. Use MANDATORILY when the "
        "response text is extensive and exceeds the character limit of the pure quick_replies "
        "component (which has a limit in the 'text' field). Separates the extensive informative "
        "content in the first message and the choice options in the second."
    ),
...
simple_text_with_list_tool = FunctionTool(
    ...
    description=(
        "Creates a simple text message followed by a list of options. Use MANDATORILY when the "
        "response text is extensive and exceeds the character limit of the pure list_message "
        "component (which has a limit in the 'text' field). Separates the extensive informative "
        "content in the first message and the detailed options in the second."
    ),
...
simple_text_with_cta_tool = FunctionTool(
    ...
    description=(
        "Creates a simple text message followed by a CTA button. Use MANDATORILY when the "
        "response text is extensive and exceeds the character limit of the pure cta_url "
        "component (which has a limit in the 'text' field). Separates the extensive informative "
        "content in the first message and the action button in the second."
    ),
...
simple_text_with_catalog_tool = FunctionTool(
    ...
    description=(
        "Creates a simple text message followed by a product catalog. Use MANDATORILY when the "
        "response text is extensive and exceeds the character limit of the pure catalog_message "
        "component (which has a limit in the 'text' field). Separates the extensive informative "
        "content in the first message and the product catalog in the second."
    ),
